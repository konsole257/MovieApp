		...
		<>
			...
			>
				<figure className="trailer-fig">
					<ReactPlayer
						src={`https://www.youtube.com/watch?v=${trailerContent.trailers[0].key}`}
						light={`https://image.tmdb.org/t/p/w1280${trailerContent.backdrop_path}`}
						controls
						playing
						muted
						width="100%"
			...
			<div className="trailer-info">
				<div className="trailer-name">
					<Skeleton loading={loading} text={trailerContent.trailers[0].name} />
				</div>
				<div className="trailer-tit">
					<Skeleton loading={loading} text={trailerContent.title} />
				</div>
				<div className="trailer-date">
					<Skeleton
						loading={loading}
						text={`公開日 ${trailerContent.release_date_current}`}
					/>
				</div>
			</div>
		</>
